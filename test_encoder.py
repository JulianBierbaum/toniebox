...
def test_encoder():
    ...
    try:
        ...
        print(
            f"Encoder initialized with bounce_time={bounce_time}. Rotate or press the knob. Press Ctrl+C to exit."
        )
        ...
        while True:
            ...
            if current_steps != last_steps:
                print(
                    f"Rotated! Steps: {current_steps} (Delta: {current_steps - last_steps})"
                )
